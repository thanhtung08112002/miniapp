    ...
    <section className="py-12">
      <div className="text-center mb-12">
        <h2 className="text-3xl font-bold text-primary mb-4">
          {t('services.generalHealthCheck.title')}
        </h2>
        <p className="text-gray-600 max-w-2xl mx-auto">
          {t('services.generalHealthCheck.description')}
        </p>
      </div>

      <div className="grid md:grid-cols-2 gap-8">
        {t('services.generalHealthCheck.packages', { returnObjects: true }).map((pkg: any, index: number) => (
          <div
            key={index}
...
export default GeneralHealthCheck; 